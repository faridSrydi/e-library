...
<html lang="id">
  <head>
    ...
    <title>Masuk — Gerbang Literasi</title>
    ...
    <div class="login-page">
      <div class="login-image">
        <div class="login-image-content">
          <h2>Selamat Datang di<br />Gerbang Literasi</h2>
          <p>
            Platform modern untuk mengelola koleksi buku, memantau peminjaman,
            dan mengakses ribuan judul buku.
          </p>
          <div class="login-image-stats">
            <div class="stat-item">
              <div class="stat-num"><?= number_format($total_buku); ?>+</div>
              <div class="stat-text">Koleksi Buku</div>
            </div>
            <div class="stat-item">
              <div class="stat-num"><?= number_format($total_user); ?>+</div>
              <div class="stat-text">Anggota Aktif</div>
            </div>
            <div class="stat-item">
              <div class="stat-num"><?= $kepuasan; ?>%</div>
      ...
      <div class="login-form-side">
        <div class="login-form-inner">
          ...
          <div class="text-center mb-4">
            ...
            <p class="text-muted small mb-0">Masuk sebagai anggota atau admin</p>
          </div>

          <?php display_flash(); ?>

          <form action="<?= BASE_URL; ?>actions/auth_action.php?action=login" method="POST">
            <input type="hidden" name="csrf_token" value="<?= generate_csrf_token(); ?>" />
            <div class="mb-3">
              <label class="form-label" for="loginEmail">Email</label>
              <div class="input-group">
                <span class="input-group-text"><i class="bi bi-envelope"></i></span>
                <input type="email" name="email" class="form-control" id="loginEmail" placeholder="email@gerbangliterasi.id" required />
              </div>
            </div>
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <input type="password" name="password" class="form-control border-end-0" id="loginPassword" placeholder="••••••••" required />
                <button class="btn btn-light border border-start-0 px-3" type="button" onclick="togglePassword('loginPassword', 'togglePasswordIcon')" style="border-color: #dee2e6 !important;">
          ...
          <div class="p-3 rounded" style="background: #f8fafc; border: 1px solid var(--border)">
            <p class="small fw-semibold mb-2"><i class="bi bi-info-circle me-1 text-primary"></i>Akun Demo Produksi</p>
            <p class="small text-muted mb-1"><strong>Admin:</strong> admin@gerbangliterasi.id / admin123</p>
            <p class="small text-muted mb-0"><strong>Anggota:</strong> user@gerbangliterasi.id / user123</p>
          </div>
        </div>
      </div>
    </div>
